...
public class StringSearchTests_FindFirstMatch
{
    ...
    {
        // Arrange
        StringSearch search = new StringSearch("world", caseSensitive: true);
    ...
    {
        // Arrange
        StringSearch search = new StringSearch("xyz", caseSensitive: true);
        string text = "Hello world!";
    ...
    {
        // Arrange
        StringSearch search = new StringSearch("Hello", caseSensitive: true);
        string text = "Hello world!";
    ...
    {
        // Arrange
        StringSearch search = new StringSearch("ab", caseSensitive: true);
    ...
    {
        // Arrange
        StringSearch search = new StringSearch("aba", caseSensitive: true);
        string text = "ababa";
    ...
    {
        // Arrange
        StringSearch search = new StringSearch("w", caseSensitive: true);
        string text = "Hello world!";
    ...
    {
        // Arrange
        StringSearch search = new StringSearch("test", caseSensitive: true);
        string text = "";
    ...
    {
        // Arrange
        StringSearch search = new StringSearch("Hello world!", caseSensitive: true);
        string text = "Hello";
    ...
    {
        // Arrange
        StringSearch search = new StringSearch("world", caseSensitive: false);
        string text = "Hello world!";
    ...
    {
        // Arrange
        StringSearch search = new StringSearch("xyz", caseSensitive: false);
        string text = "Hello world!";
    ...
    {
        // Arrange
        StringSearch search = new StringSearch("AB", caseSensitive: false);
        string text = "ab cd AB ef";
    ...
    {
        // Arrange
        StringSearch search = new StringSearch("wor", caseSensitive: true);
        string text = "Hello world test";
    ...
    {
        // Arrange
        StringSearch search = new StringSearch("WOR", caseSensitive: false);
        string text = "Hello world test";
    ...
    {
        // Arrange
        StringSearch search = new StringSearch("ķi", caseSensitive: true);
    ...
    {
        // Arrange
        StringSearch search = new StringSearch("gur", caseSensitive: true);
        string text = "āboli.gurķi.ķiploki";
    ...
    {
        // Arrange
        StringSearch search = new StringSearch("GURĶI", caseSensitive: false);
        string text = "āboli.gurķi.ķiploki";
    ...
    {
        // Arrange
        StringSearch search = new StringSearch("ababaca", caseSensitive: true);
    ...
    {
        // Arrange
        StringSearch search = new StringSearch("aaaa", caseSensitive: true);
        string text = "aaaaab";
    ...
    {
        // Arrange
        StringSearch search = new StringSearch("abcabc", caseSensitive: true);
    ...
    {
        // Arrange
        StringSearch search = new StringSearch("!@#", caseSensitive: true);
        string text = "abc!@#def";
    ...
    {
        // Arrange
        StringSearch search = new StringSearch("мир", caseSensitive: true);
    ...
    {
        // Arrange
        StringSearch search = new StringSearch("var", caseSensitive: true);
    ...
    {
        // Arrange & Act
        StringSearch search = new StringSearch("TEST", caseSensitive: false);
