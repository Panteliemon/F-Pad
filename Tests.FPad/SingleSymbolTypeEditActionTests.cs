...
public class SingleSymbolTypeEditActionTests : IClassFixture<EncodingTestsFixture>
{
    ...
    public void Apply_Rollback_RoundTrip_TypeLetter()
    {
        ...
        var action = new SingleSymbolTypeEditAction(prefix.Length, suffix.Length, "", inserted);
    ...
    public void Absorb_SameType_Appends()
    {
        ...
        editor.TextNoUndo = initialText;
        var action1 = new SingleSymbolTypeEditAction(1, 1, "", "c"); // insert 'c' at position 1
        var action2 = new SingleSymbolTypeEditAction(2, 1, "", "d"); // insert 'd' at position 2 (after 'c')
        ...
        Assert.Equal(new Selection(1 + 2, 0), testEditor.Selection); // after "cd"
    ...
    public void Absorb_SameType_InsertsInMiddle()
    {
        ...
        string initialText = "ab";
        editor.TextNoUndo = initialText;
        var action1 = new SingleSymbolTypeEditAction(1, 1, "", "cd"); // insert "cd" at position 1
        var action2 = new SingleSymbolTypeEditAction(2, 2, "", "e"); // insert 'e' at position 2 (between 'c' and 'd')
        ...
        Assert.Equal(new Selection(1 + 3, 0), testEditor.Selection); // after "ced"
    ...
    {
        // Arrange
        var action1 = new SingleSymbolTypeEditAction(1, 2, "", "a"); // 'a' is Word
        var action2 = new SingleSymbolTypeEditAction(1, 1, "", " "); // ' ' is Space
    ...
    {
        // Arrange
        var action1 = new SingleSymbolTypeEditAction(1, 2, "", "a");
        var action2 = new SingleSymbolTypeEditAction(1, 1, "b", "a"); // has erased
    ...
    {
        // Arrange
        var action1 = new SingleSymbolTypeEditAction(1, 2, "", "a"); // inserts at 1, inserted length 1, so range 1 to 2
        var action2 = new SingleSymbolTypeEditAction(3, 1, "", "a"); // position 3, out of range
